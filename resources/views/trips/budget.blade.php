<x-app-layout>
    ...
    <header class="mb-stack-lg flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <button onclick="document.getElementById('edit-categories-modal').classList.remove('hidden')" class="btn-primary shadow-lg shadow-primary/20">
            <span class="material-symbols-outlined">edit_note</span> Manage Budgets
        </button>
    </header>
