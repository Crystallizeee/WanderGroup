...
<head>
    ...
    <title>{{ config('app.name', 'WanderGroup') }} - {{ $title ?? 'Travel Together' }}</title>
    <meta name="description" content="{{ $metaDescription ?? 'WanderGroup — Collaborative group travel planning. Coordinate itineraries, split expenses, and plan together.' }}">
